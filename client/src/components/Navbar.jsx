        ...
        <div className='flex items-center justify-between py-5 font-medium'>
           <Link to='/'><img src={assets.logo} className='w-36' alt='' /></Link>
            ...
            <div className='flex items-center gap-6'>
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black aspect-square rounded-full text-white text-[8px]'>{getCartCount()}</p>
                </Link>
            ...
            <div className='flex flex-col text-gray-600'>
                ...
                <NavLink onClick={() => setVisible(false)} className="py-2 pl-6 border-t"to='/home'>HOME</NavLink>
