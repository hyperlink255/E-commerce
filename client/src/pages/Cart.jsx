       ...
       <div>
        {
          cartData.map((item,i) => {
            ...
            return (
                <div key={i} className='py-4 border-t border-b border-gray-200 text-gray-700 grid grid-cols-[4fr_2fr_0.5fr] items-center gap-2'>
                ...
                <div className="flex items-start gap-6">
                 ...
                 <input onChange={(e) => e.target.value === ""  || e.target.value === "0" ? null : updateQuantity(item._id,item.size,Number(e.target.value))} className='border max-w-10 sm:max-w-20  border-gray-200 px-1 sm:px-2 py-1' type="number" min={1} defaultValue={item.quantity}/>
