...
const PlaceOreder = () => {
  const {navigate,token,cartItmes,setCartItems,getCartAmount,delivery_fee,products,axios} = useContext(ShopContext)
    ...
    try{
         ...
         switch(method){
          case "cod":
            ...
            case "stripe" :
              const resStripe = await axios.post('/api/order/stripe',orderData,{headers:{token}})
